...
def rewrite_file_for_96f(filename: str):
    with open(reccmp_dir / filename, "r") as f:
        csv_lines = [
            line for line in f
    ...
    with open(reccmp_dir / f"96f-{filename}", "w+") as f:
        f.write(csv_lines[0])
...
rewrite_file_for_96f("library.csv")
rewrite_file_for_96f("fix16.csv")
